...
async def run_test():
    ...
    try:
        ...
        # -> Click on Update Profile link to navigate to profile edit page.
        frame = context.pages[-1]
        # Click on Update Profile link to go to profile edit page.
        ...
        try:
            ...
            raise AssertionError("Test case failed: The profile update and password change process did not complete successfully as per the test plan. Expected confirmation message 'Profile update successful!' was not found on the page.")
